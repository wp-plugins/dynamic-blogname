=== Dynamic Blogname ===
Contributors: kaaquantum
Donate link: andrewkiselev.com
...
Just use a button "Add New" in Plugin section of your Wordpress blog's Control panel :) 
...
= 1.0.2 =
* Corrected way getting 'titles.txt' from by http-url to by abs. filesystem path.
